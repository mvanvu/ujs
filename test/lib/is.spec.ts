...
it('Core Is', () => {
   ...
   // ## Image
   const img = 'https://2.img-dpreview.com/files/p/E~C1000x0S4000x4000T1200x1200~articles/3925134721/0266554465.jpeg';
   expect(Is.stringFormat(img, 'image')).toBeTruthy();
   expect(Is.stringFormat(img + '?size=large', 'image')).toBeTruthy();
